...
// mirror pixels
// #define IMX586_MIRROR_PIXELS_STAH			0X0344
// #define IMX586_MIRROR_PIXELS_STAL			0X0345
// #define IMX586_MIRROR_PIXELS_ENDH			0X0348
// #define IMX586_MIRROR_PIXELS_ENDL			0X0349
// filp pixels
// #define IMX586_FILP_PIXELS_STAH			0X0346
// #define IMX586_FILP_PIXELS_STAL			0X0347
// #define IMX586_FILP_PIXELS_ENDH			0X034A
// #define IMX586_FILP_PIXELS_ENDL			0X034B
...
static u8 trackid[16] = {
	1, 4, 2, 2, 5, 2, 1, 0, 4, 1, 3, 9, 9, 0, 0, 0
};
#endif
...
static inline bool imx586_get_hdrmode(const struct imx586 *priv)
{
	...
	case IMX586_MODE_4000X3000_10BIT_HDR_30FPS:
		return true;
	case IMX586_MODE_4000X3000_10BIT_HDR_30FPS_MIRROR:
		return true;
	case IMX586_MODE_4000X3000_10BIT_HDR_30FPS_FLIP:
		return true;
	case IMX586_MODE_4000X3000_10BIT_HDR_30FPS_MIRROR_FLIP:
		return true;
	default:
		return false;
	}
...
static int imx586_set_flip(struct camera_common_data *s_data, u8 flip)
{
	...
	printk("%s: flip write table id: %02X\n", __func__, IMX586_FLIP_MIRROR_ADDR);
	printk("%s: flip write value is: %02X\n", __func__, val);
...
static int imx586_set_mode(struct tegracam_device *tc_dev)
{
	...
	dev_dbg(dev, "%s: imx586 set sensor_mode_id: %d\n", __func__, s_data->sensor_mode_id);
	...
	dev_dbg(dev, "%s: imx586_write_table, mode: %d-----------\n", __func__, s_data->mode_prop_idx);
	...
	if (0 == s_data->mode_prop_idx || 1 == s_data->mode_prop_idx) {
		// no mirror and flip
		imx586_set_flip(s_data, 0);
		usleep_range(50 * 1000, 51 * 1000);
	} else if (2 == s_data->mode_prop_idx || 3 == s_data->mode_prop_idx) {
		// mirror
		imx586_set_flip(s_data, 1);
		usleep_range(50 * 1000, 51 * 1000);
	} else if (4 == s_data->mode_prop_idx || 5 == s_data->mode_prop_idx) {
		// flip
		imx586_set_flip(s_data, 2);
		usleep_range(50 * 1000, 51 * 1000);
	} else if (6 == s_data->mode_prop_idx || 7 == s_data->mode_prop_idx) {
		// mirror and flip
		imx586_set_flip(s_data, 3);
		usleep_range(50 * 1000, 51 * 1000);
	}
