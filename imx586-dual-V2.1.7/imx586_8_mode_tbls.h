...
static  imx586_reg imx586_4000x3000_Nor_H2V2_BIN_30FPS[] = {
	//CSI_SIG_MODE 2: CSI-2 Signaling D-PHY 3: CSI-2 Signaling C-PHY
	//{0x0111,	0x02},
	...
	{0x0306,	0x01},		//IVT_PLL_MPY      IVTCT: 310 * 6 = 1860M
	{0x0307,	0x36},		//IVT_PLL_MPY
	...
	{0x030E,	0x02},		// IOP_PLL_MPY	 IOPCK: 550 * 4 = 2200M
	{0x030F,	0x26},		// IOP_PLL_MPY
	...
	//30fps
	IVTCK = 24M * 1/4 * 310 = 1860M
	Predivider setting =   1/IVT_PREPLLCK_DIV				// 1/4
	Pll multiple setting = 	 IVT_PLL_MPY								// 310

	IOPCK = 24M * 1/6 * 550 = 2200M
	Predivider setting = 	1/IOP_PREPLLCK_DIV		// 1/6
	Pll multiple setting = IOP_PLL_MPY						// 550

	IVTPXCK: 1860M * 1/(0x0301: 05 * 0x0303: 04) = 1860M / 20 = 93.0M
	IOPSYCK = 2200M *  1/(IOP_SYCK_DIV) = 1904M * 1/2 = 1100M
	
	Framerate = 744M /24088320  = 744000000 / 24088320 = 30.88633827514746
		Pixel_rate = IVTPXCK * 8 = 93.0M * 8 = 744M
		pixel_clk = Pixel_rate
		Total number of pixels = 3060 * 7872 = 24088320			
	*/
...
static  imx586_reg imx586_5600x4200_10Bit_Full_9FPS[] = {
	//CSI_SIG_MODE 2: CSI-2 Signaling D-PHY 3: CSI-2 Signaling C-PHY
	//{0x0111,	0x02},
	...
	//Line Length PCK Setting		, length of line: 14704

	{0x0342,	0x39},
	{0x0343,	0x70},

	//Frame Length Lines Setting	, The length of frame: 4300
	...
	/*
	IVTCK = 24M * 1/4 * 238 = 1428M
	Predivider setting =   1/IVT_PREPLLCK_DIV				// 1/4
	Pll multiple setting = 	 IVT_PLL_MPY								// 238
	...
	IVTPXCK: 1428M * 1/(0x0301: 05 * 0x0303: 04) = 1428M / 20 = 71.4M
	IOPSYCK = 1600M *  1/(IOP_SYCK_DIV) = 1600M * 1/2 = 800M
	...
	Framerate = 571.2M /63227200  = 571200000 / 63227200 = 9.034086595642382
		Pixel_rate = IVTPXCK * 8 = 74.7M * 8 = 571.2M = 571200000
		pixel_clk = Pixel_rate
		Total number of pixels = 4300 * 14704 = 63,227,200	
...
static  imx586_reg imx586_5600x4200_10Bit_Full_27FPS[] = {
	//CSI_SIG_MODE 2: CSI-2 Signaling D-PHY 3: CSI-2 Signaling C-PHY
	//{0x0111,	0x02},
	...
	//{0x030E,	0x02},		// IOP_PLL_MPY	 IOPCK: 536 * 4 = 2144M
	//{0x030F,	0x18},		// IOP_PLL_MPY

	//{0x030E,	0x02},		// IOP_PLL_MPY	 IOPCK: 521 * 4 = 2084M
	//{0x030F,	0x09},		// IOP_PLL_MPY
	...
	IOPCK = 24M * 1/6 * 521 = 2084M
	Predivider setting = 	1/IOP_PREPLLCK_DIV		1/6
	Pll multiple setting = IOP_PLL_MPY						521
	...
	IVTPXCK: 2160M * 1/(0x0301: 05 * 0x0303: 02) = 2160M / 10 = 216.0M
	IOPSYCK = 2500M *  1/(IOP_SYCK_DIV) = 2500M * 1/1 = 2500M
	...
	Framerate = 1718.4M /63227200  = 1718400000 / 63227200 = 27.17817648100817
		Pixel_rate = IVTPXCK * 8 = 214.8M * 8 = 1718.4M

	Framerate = 1728.0M /63227200  = 1728000000 / 63227200 = 27.33000986917023	
		Pixel_rate = IVTPXCK * 8 = 216.0M * 8 = 1728.0M
...
static  imx586_reg imx586_8000x6000_10Bit_Full_Raw_6FPS[] = {
	//CSI_SIG_MODE 2: CSI-2 Signaling D-PHY 3: CSI-2 Signaling C-PHY
	//{0x0111,	0x02},
	...
	//Line Length PCK Setting			: 14704	
	{0x0342,	0x39},
	{0x0343,	0x70},	
		
	//Frame Length Lines Setting			:6060
	{0x0340,	0x17},
	{0x0341,	0xAC},
	...
	//Mode Setting		
	{0x0220,	0x62},//hdr_mode
	{0x0222,	0x01},
	{0x0900,	0x00},
	{0x0901,	0x11},
	{0x0902,	0x0A},
	{0x3140,	0x00},//hdr_fncsel
	{0x3246,	0x01},
	{0x3247,	0x01},
	{0x3F15,	0x00},
	...
	{0x0303,	0x04},//ivt_syck_div
	{0x0305,	0x04},	// IVT_PREPLLCK_DIV : 24M/4 = 6 M
	{0x0306,	0x00},// IVT_PLL_MPY, Internal Video  Timing System Clock: 238
	{0x0307,	0xEE},
	{0x030B,	0x02},// IOP_SYCK_DIV,   IOPSYCK frequency:525.0MHz - 1250.0MHz
	{0x030D,	0x06},// IOP_PREPLLCK_DIV
	{0x030E,	0x01},//  IOP_PLL_MPY: 400
	{0x030F,	0x90},
	
	{0x0310,	0x01},	// PLL_MULT_DRIV,  0: 0 : Single PLL mode,   1 : Dual PLL mode
...
static  imx586_reg imx586_8000x6000_10Bit_Full_6FPS[] = {
	//CSI_SIG_MODE 2: CSI-2 Signaling D-PHY 3: CSI-2 Signaling C-PHY
	//{0x0111,	0x02},
	...
	//Integration Setting		( COARSE_INTEG_TIME)
	{0x0202,	0x17},
	{0x0203,	0x7C},
	// Exposure time
	{0x0224,	0x01},
...
enum {	
	...
	IMX586_MODE_4000X3000_10BIT_NOR_H2V2_BIN_30FPS,	
	IMX586_MODE_5600X4200_10BIT_FULL_9FPS,	
	IMX586_MODE_5600X4200_10BIT_FULL_27FPS,	
	IMX586_MODE_8000X6000_10BIT_FULL_RAW_6FPS,	
	IMX586_MODE_8000X6000_10BIT_FULL_6PS,
...
static imx586_reg *mode_table[] = {
	...
	[IMX586_MODE_4000X3000_10BIT_NOR_H2V2_BIN_30FPS] = imx586_4000x3000_Nor_H2V2_BIN_30FPS,
	[IMX586_MODE_5600X4200_10BIT_FULL_9FPS] = imx586_5600x4200_10Bit_Full_9FPS,
	[IMX586_MODE_5600X4200_10BIT_FULL_27FPS] = imx586_5600x4200_10Bit_Full_27FPS,
	[IMX586_MODE_8000X6000_10BIT_FULL_RAW_6FPS] = imx586_8000x6000_10Bit_Full_Raw_6FPS,
	[IMX586_MODE_8000X6000_10BIT_FULL_6PS] = imx586_8000x6000_10Bit_Full_6FPS,
...
static const struct camera_common_frmfmt imx586_frmfmt[] = {
	...
	{{4000, 3000}, imx586_35fps, 1, 0,
			IMX586_MODE_4000X3000_10BIT_NOR_H2V2_BIN_35FPS},
	{{4000, 3000}, imx586_30fps, 1, 0,
			IMX586_MODE_4000X3000_10BIT_NOR_H2V2_BIN_30FPS},
	{{5600, 4200}, imx586_9fps, 1, 0,
			IMX586_MODE_5600X4200_10BIT_FULL_9FPS},
	{{5600, 4200}, imx586_27fps, 1, 0,
			IMX586_MODE_5600X4200_10BIT_FULL_27FPS},			
	{{8000, 6000}, imx586_6fps, 1, 0,
			IMX586_MODE_8000X6000_10BIT_FULL_RAW_6FPS},
	{{8000, 6000}, imx586_6fps, 1, 0,
			IMX586_MODE_8000X6000_10BIT_FULL_6PS},
};
